...
@section('dashboard-content')
    ...
    <form action="{{ URL::to('store-blog-post')}}" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control mt-3" id="blogTitle" name="blogTitle"aria-describedby="emailHelp" placeholder="Enter blog title">
        </div>

        <div class="form-group">
            <label for="blogDetails">Blog details</label>
            <textarea class="form-control"  id="blogDetails" name="blogDetails"></textarea>
        </div>
